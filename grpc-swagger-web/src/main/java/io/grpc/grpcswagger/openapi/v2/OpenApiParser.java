...
/**
 * Parser for generating SwaggerV2Documentation from gRPC services.
 * Adds endPoint support for documentation.
 *
 * Author: liuzhengyang
 */
public class OpenApiParser {
     ...
     */
    public static SwaggerV2Documentation parseDefinition(ServiceResolver serviceResolver, String endPoint) {
